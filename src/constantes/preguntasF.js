...
export const CategoriasPreguntas = [
    ...
    preguntas: [
      {
        ...
        respuesta: `Nuestro sistema de pagos cuenta con tecnología avanzada en seguridad informática y encriptado bilateral, sin embargo en caso de presentarse alguna
    inconsistencia con tus pagos o facturación puedes realizar tu reclamo en el chat de soporte 24/7 o en cualquiera de nuestras líneas de atención presentes en www.domesticapp.com.co, nuestro equipo de atención al cliente le dará la mayor celeridad a tu requerimiento.`,
      },
      {
        id: 2,
        pregunta:
    ...
    preguntas: [
      {
        ...
        respuesta: `En Domesticapp encuentras pilares no
        negociables: Cuidamos tu bolsillo, Protegemos tus espacios y garantizamos la máxima satisfacción. Además accedes a beneficios de nuestros aliados solo por usar nuestros servicios, restaurantes, teatros, cinemas y demás.`,
      },
      {
        id: 2,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: 1,
        pregunta: `1.8.1 ¿En que casos puedo acceder a una
        devolución?`,
      ...
      },
      {
        ...
        respuesta: `En todas nuestras plataformas cuentas con
        servicio de atención al cliente 24/7, ChatBot de respuestas automatizadas y atención vía email.`,
      },
    ],
  },
];
